        ...
        <div class="account-layout">
            <div class="account-head mb-10">
                <span class="account-heading">
                    <h3>{{ __('gdpr::app.shop.customer.cookie.your-cookie-consent-preferences') }}</h3>
                </span>
                <div class="account-action">
                    <button type="submit" class="btn btn-mg btn-primary mt-10 cookie-customize-btn" onclick="getCustomizeCookie();">
